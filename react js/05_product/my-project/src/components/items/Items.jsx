...
function Items({ product, handleGetProductId }) {
  ...
  return (
    <div className="item-container p-4 border rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 " onClick={()=>handleGetProductId(id)}>
      ...
      <div className="p-4">
        ...
        <div className="item-price-section mt-4">
          <p className="item-final-price text-lg font-bold text-green-600">₹{finalPrice.toFixed(2)} <span className=" text-sm line-through font-thin text-gray-500">₹{price}</span></p>
