  ...
  return (
    <div>
      <ul className="flex justify-between items-center border-b pb-2 mb-2">
        ...
        <li className="w-1/4 text-teal-800">${price.toFixed(2)}</li>
        <li className="w-1/4 flex items-center">
          <div className="flex items-center">
            <button className="px-2 py-1 bg-gray-700 " onClick={handleDec}>
              -
            </button>
            <span className="mx-2 text-teal-800">{quantity}</span>
            <button className="px-2 py-1 bg-gray-700" onClick={handleInc}>
              +
            </button>
          </div>
        </li>
        <li className="w-1/4 text-teal-800">${itemPrice.toFixed(2)}</li>
        <button
